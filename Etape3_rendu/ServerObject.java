			...
			*/
			for (int i =0; i<lecteurs.size(); i++){
				...
				if(!lecteurs.get(i).equals(cl)) {
					//System.out.println("Le Client lecteur suivant est invalidé : " + lecteurs.get(i).hashCode());
					lecteurs.get(i).invalidate_reader(id);
					//System.out.println("Le Client lecteur suivant a été invalidé : " + lecteurs.get(i).hashCode());
				}
